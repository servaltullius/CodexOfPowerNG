(function (root, factory) {
  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      ...
      "build.attack.momentum.title": "Momentum",
      "build.attack.momentum.description": "Extends the attack-chain timing window for sustained offense.",
      ...
      "build.defense.stalwart.title": "Stalwart",
      "build.defense.stalwart.description": "+25 carry weight while this option is slotted.",
      "build.utility.cache.title": "Cache",
      "build.utility.cache.description": "+25 carry weight for long expeditions.",
      "build.utility.barter.title": "Barter",
      "build.utility.barter.description": "Improves vendor prices by 10% while active.",
      "build.utility.scout.title": "Scout",
      "build.utility.scout.description": "Reveals nearby loot more easily while exploring.",
    ...
    ko: Object.freeze({
      ...
      "build.attack.ferocity.description": "슬롯에 넣는 동안 공격 피해가 5% 증가합니다.",
      "build.attack.precision.title": "정밀",
      "build.attack.precision.description": "슬롯에 넣는 동안 무기 속도가 3% 증가합니다.",
      "build.attack.momentum.title": "가속",
      "build.attack.momentum.description": "연속 공격의 유지 타이밍이 넉넉해집니다.",
      "build.defense.guard.title": "수호",
      "build.defense.guard.description": "슬롯에 넣는 동안 방어력이 10 증가합니다.",
      "build.defense.bastion.title": "보루",
      "build.defense.bastion.description": "슬롯에 넣는 동안 막기 효율이 15% 증가합니다.",
      "build.defense.stalwart.title": "강건",
      "build.defense.stalwart.description": "슬롯에 넣는 동안 소지 한도가 25 증가합니다.",
      "build.utility.cache.title": "비축",
      "build.utility.cache.description": "장거리 탐험을 위해 소지 한도가 25 증가합니다.",
      "build.utility.barter.title": "흥정",
      "build.utility.barter.description": "활성화 중에는 상인 거래 가격이 10% 유리해집니다.",
      "build.utility.scout.title": "정찰",
      "build.utility.scout.description": "탐험 중 주변 전리품을 더 쉽게 찾아냅니다.",
