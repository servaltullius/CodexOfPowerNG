...
namespace
{
	...
	bool CuratedAttackEffectsResolveToConcreteActorValues()
	{
		...
		if (!LookupTotal(anchorTotals, RE::ActorValue::kAttackDamageMult).has_value() ||
		    ...
		    !NearlyEqual(*LookupTotal(anchorTotals, RE::ActorValue::kWeaponSpeedMult), 0.045f) ||
		...
		if (!LookupTotal(expansionTotals, RE::ActorValue::kAttackDamageMult).has_value() ||
		    !NearlyEqual(*LookupTotal(expansionTotals, RE::ActorValue::kAttackDamageMult), 0.06f) ||
		    !LookupTotal(expansionTotals, RE::ActorValue::kWeaponSpeedMult).has_value() ||
		    !NearlyEqual(*LookupTotal(expansionTotals, RE::ActorValue::kWeaponSpeedMult), 0.045f) ||
		    !LookupTotal(expansionTotals, RE::ActorValue::kCriticalChance).has_value() ||
		    !NearlyEqual(*LookupTotal(expansionTotals, RE::ActorValue::kCriticalChance), 3.5f)) {
			return false;
		}
		...
		return LookupTotal(devastationTotals, RE::ActorValue::kUnarmedDamage).has_value() &&
		       ...
		       NearlyEqual(*LookupTotal(devastationTotals, RE::ActorValue::kDestructionModifier), 0.8f);
	}
	...
	bool CuratedDefenseEffectsResolveToConcreteActorValues()
	{
		...
		if (!LookupTotal(guardTotals, RE::ActorValue::kDamageResist).has_value() ||
		    !NearlyEqual(*LookupTotal(guardTotals, RE::ActorValue::kDamageResist), 16.0f) ||
		    !LookupTotal(guardTotals, RE::ActorValue::kBlockPowerModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(guardTotals, RE::ActorValue::kBlockPowerModifier), 24.0f)) {
			return false;
		}
		...
		if (!LookupTotal(bulwarkTotals, RE::ActorValue::kDamageResist).has_value() ||
		    !NearlyEqual(*LookupTotal(bulwarkTotals, RE::ActorValue::kDamageResist), 16.0f) ||
		    !LookupTotal(bulwarkTotals, RE::ActorValue::kHealth).has_value() ||
		    !NearlyEqual(*LookupTotal(bulwarkTotals, RE::ActorValue::kHealth), 20.0f)) {
			return false;
		}
		...
		if (!LookupTotal(enduranceTotals, RE::ActorValue::kHealth).has_value() ||
		    !NearlyEqual(*LookupTotal(enduranceTotals, RE::ActorValue::kHealth), 30.0f) ||
		...
		if (!LookupTotal(sustainTotals, RE::ActorValue::kHealRate).has_value() ||
		    !NearlyEqual(*LookupTotal(sustainTotals, RE::ActorValue::kHealRate), 0.06f) ||
		    !LookupTotal(sustainTotals, RE::ActorValue::kRestorationModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(sustainTotals, RE::ActorValue::kRestorationModifier), 0.9f)) {
			return false;
		}
		...
		return LookupTotal(bastionSpecialTotals, RE::ActorValue::kReflectDamage).has_value() &&
		       NearlyEqual(*LookupTotal(bastionSpecialTotals, RE::ActorValue::kReflectDamage), 0.6f) &&
		       LookupTotal(bastionSpecialTotals, RE::ActorValue::kAlterationModifier).has_value() &&
		       NearlyEqual(*LookupTotal(bastionSpecialTotals, RE::ActorValue::kAlterationModifier), 0.8f);
	}
	...
	bool CuratedResistanceEffectsResolveToConcreteActorValues()
	{
		...
		if (!LookupTotal(wardingTotals, RE::ActorValue::kResistMagic).has_value() ||
		    !NearlyEqual(*LookupTotal(wardingTotals, RE::ActorValue::kResistMagic), 6.0f) ||
		...
		if (!LookupTotal(elementalTotals, RE::ActorValue::kResistFire).has_value() ||
		    !NearlyEqual(*LookupTotal(elementalTotals, RE::ActorValue::kResistFire), 7.0f) ||
		    !LookupTotal(elementalTotals, RE::ActorValue::kResistFrost).has_value() ||
		    !NearlyEqual(*LookupTotal(elementalTotals, RE::ActorValue::kResistFrost), 7.0f) ||
		    !LookupTotal(elementalTotals, RE::ActorValue::kResistShock).has_value() ||
		    !NearlyEqual(*LookupTotal(elementalTotals, RE::ActorValue::kResistShock), 7.0f)) {
			return false;
		}
		...
		if (!LookupTotal(statusTotals, RE::ActorValue::kPoisonResist).has_value() ||
		    !NearlyEqual(*LookupTotal(statusTotals, RE::ActorValue::kPoisonResist), 7.0f) ||
		    !LookupTotal(statusTotals, RE::ActorValue::kResistDisease).has_value() ||
		    !NearlyEqual(*LookupTotal(statusTotals, RE::ActorValue::kResistDisease), 7.0f)) {
			return false;
		}
	...
	bool CuratedUtilityEffectsResolveToConcreteActorValues()
	{
		...
		if (!LookupTotal(livelihoodTotals, RE::ActorValue::kCarryWeight).has_value() ||
		    !NearlyEqual(*LookupTotal(livelihoodTotals, RE::ActorValue::kCarryWeight), 70.0f) ||
		    !LookupTotal(livelihoodTotals, RE::ActorValue::kSpeechcraftModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(livelihoodTotals, RE::ActorValue::kSpeechcraftModifier), 0.8f)) {
			return false;
		}
		...
		if (!LookupTotal(craftingTotals, RE::ActorValue::kSmithingModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(craftingTotals, RE::ActorValue::kSmithingModifier), 0.8f) ||
		    !LookupTotal(craftingTotals, RE::ActorValue::kAlchemyModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(craftingTotals, RE::ActorValue::kAlchemyModifier), 0.8f) ||
		    !LookupTotal(craftingTotals, RE::ActorValue::kEnchantingModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(craftingTotals, RE::ActorValue::kEnchantingModifier), 0.8f)) {
			return false;
		}
		...
		if (!LookupTotal(explorationTotals, RE::ActorValue::kSpeedMult).has_value() ||
		    !NearlyEqual(*LookupTotal(explorationTotals, RE::ActorValue::kSpeedMult), 0.075f)) {
			return false;
		}
		...
		if (!LookupTotal(trickeryTotals, RE::ActorValue::kSneakingModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(trickeryTotals, RE::ActorValue::kSneakingModifier), 0.8f) ||
		    !LookupTotal(trickeryTotals, RE::ActorValue::kLockpickingModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(trickeryTotals, RE::ActorValue::kLockpickingModifier), 0.8f) ||
		    !LookupTotal(trickeryTotals, RE::ActorValue::kConjurationModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(trickeryTotals, RE::ActorValue::kConjurationModifier), 0.8f)) {
			return false;
		}
		...
		if (!LookupTotal(trickerySpecialTotals, RE::ActorValue::kPickpocketModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(trickerySpecialTotals, RE::ActorValue::kPickpocketModifier), 0.8f) ||
		    !LookupTotal(trickerySpecialTotals, RE::ActorValue::kIllusionModifier).has_value() ||
		    !NearlyEqual(*LookupTotal(trickerySpecialTotals, RE::ActorValue::kIllusionModifier), 0.8f)) {
			return false;
		}
		...
		if (!LookupTotal(livelihoodResourceTotals, RE::ActorValue::kMagicka).has_value() ||
		    !NearlyEqual(*LookupTotal(livelihoodResourceTotals, RE::ActorValue::kMagicka), 5.0f) ||
		...
		return LookupTotal(explorationSpecialTotals, RE::ActorValue::kShoutRecoveryMult).has_value() &&
		       NearlyEqual(*LookupTotal(explorationSpecialTotals, RE::ActorValue::kShoutRecoveryMult), -0.05f);
	}
	...
	bool OnceOnlyEffectsDoNotDoubleStackAcrossSlots()
	{
		...
		return LookupTotal(totals, RE::ActorValue::kAttackDamageMult).has_value() &&
		       NearlyEqual(*LookupTotal(totals, RE::ActorValue::kAttackDamageMult), 0.08f);
	}
