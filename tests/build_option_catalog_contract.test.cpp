...
namespace
{
	...
	bool HasExpectedCatalogContents()
	{
		...
		constexpr std::array expectedOptions{
			...
			ExpectedOption{ "build.attack.reserve", BuildDiscipline::Attack, "fury", "build.theme.attack.fury", "signpost", 400u, BuildEffectType::ActorValue, "reserve_bundle" },
			...
			ExpectedOption{ "build.utility.meditation", BuildDiscipline::Utility, "livelihood", "build.theme.utility.livelihood", "standard", 2400u, BuildEffectType::ActorValue, "meditation_bundle" },
			...
			ExpectedOption{ "build.utility.magicka", BuildDiscipline::Utility, "livelihood", "build.theme.utility.livelihood", "special", 2400u, BuildEffectType::ActorValue, "magicka_well_bundle" },
			ExpectedOption{ "build.utility.hauler", BuildDiscipline::Utility, "livelihood", "build.theme.utility.livelihood", "standard", 2400u, BuildEffectType::ActorValue, "hauler_bundle" },
		...
		constexpr std::array expectedScaling{
			...
			ExpectedScaling{ "build.attack.reserve", 8.0f, 2.0f },
