...
namespace
{
	...
	bool HasExpectedCatalogContents()
	{
		...
		constexpr std::array expectedOptions{
			...
			ExpectedOption{ "build.attack.vitals", BuildDiscipline::Attack, "precision", "build.theme.attack.precision", "special", 30u, BuildEffectType::ActorValue, "attack_damage_mult" },
			ExpectedOption{ "build.attack.reserve", BuildDiscipline::Attack, "fury", "build.theme.attack.fury", "signpost", 10u, BuildEffectType::ActorValue, "stamina" },
			ExpectedOption{ "build.attack.secondwind", BuildDiscipline::Attack, "fury", "build.theme.attack.fury", "standard", 15u, BuildEffectType::ActorValue, "stamina_rate" },
			...
			ExpectedOption{ "build.defense.recovery", BuildDiscipline::Defense, "guard", "build.theme.defense.guard", "standard", 25u, BuildEffectType::ActorValue, "heal_rate" },
			ExpectedOption{ "build.defense.restoration", BuildDiscipline::Defense, "guard", "build.theme.defense.guard", "special", 35u, BuildEffectType::ActorValue, "restoration_modifier" },
